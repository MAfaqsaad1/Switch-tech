        ...
        <>
            <div className="flex items-center md:px-36 px-5 py-5 justify-between">
                ...
                <div className="search hidden lg:block">
                    <div className="flex items-center py-2 ">
                        <input type="search" placeholder="search" className="outline-none px-2 py-2 lg:w-80 border-2" name="" id="" />
                ...
                <div className="call border-spacing-2 hidden sm:block hover:bg-primary hover:text-white transition-all border-2 px-8 py-2 border-primary">
                    <a href="tel:+92 308 488 6911"> Call Us Now</a>
            ...
            <div className="overflow-hidden">
                ...
                <div className="divide-y lg:divide-none  bg-primary uppercase py-3 lg:py-5   overflow-hidden w-full text-white flex flex-col lg:flex-row items-center lg:space-x-10 justify-center">
                    ...
                    <Link className="hover:text-gray-200" to="/about">About Us</Link>
                    <Link className="hover:text-gray-200" to="/brands">Brands</Link>
                    <Link className="hover:text-gray-200" to="/product">Product</Link>
                    <Link className="hover:text-gray-200" to="/Categories">CATEGORIES</Link>
                    <Link className="hover:text-gray-200" to="/blogs">blogs</Link>
                    <Link className="hover:text-gray-200" to="/quote">REQUEST A QUOTE</Link>
