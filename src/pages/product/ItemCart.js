            ...
            <div className="hover:shadow-lg product_card p-2 border bg-white  hover:text-primary transition-all text-black  group" >
                <div className='px-4 py-4' >
                    <div className="bg-white mb-3 w-full h-36 relative  overflow-hidden" >
                        ...
                        >
                            <img src={props.img} alt="" srcset="" className='object-cover h-36 mx-auto' />
                ...
                <div className="text-center py-2 px-4">
                    <button onClick={() => { alert("item is added to Cart"); addItem(props.item); }} className='bg-transparent w-full py-2 group-hover:bg-primary hover:bg-secondry text-white'>Add To Quote</button>
                </div>
            </div>
